...
use crate::{starts, ExecutionAction};
use parity_daemonize::AsHandle;
use parking_lot::{Condvar, Mutex};
use crate::configuration::{Configuration, Execute, Cmd};
use crate::run;
...
fn execute<Cr, Rr>(
	command: crate::configuration::Execute,
...
pub fn main_direct(force_can_restart: bool, mut conf: Configuration) -> i32 {
	global_init();
